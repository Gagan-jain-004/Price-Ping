...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-linear-to-br from-orange-50 via-white to-orange-50">  {/* this spreads color from top to bottom right  */}
      {/* Header */}
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-orange-100 text-orange-700 px-6 py-2 rounded-full text-sm font-medium mb-6">
            Paste Any E-Commerce URL & Track Prices
          </div>
